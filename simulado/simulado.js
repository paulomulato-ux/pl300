...
const questionBank = {
  ...
  "Preparar Dados": [
        ...
        },
        {
            ...
            opcoes: ["Implementar Row-Level Security (RLS) baseada no remetente.", "Remover as colunas Subject e Body durante a importação (no Power Query).", "Ocultar (Hide) as colunas Subject e Body na visualização do modelo.", "Mascarar os textos dos e-mails usando DAX."],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Remover a coluna de Status do Produto.", "Remover linhas de produtos inativos.", "Remover as linhas referentes a vendas que ocorreram há mais de dois anos.", "Ocultar as colunas não usadas na exibição de relatório."],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Arredondar a hora para o início da hora.", "Mudar o tipo de dado para Texto.", "Cortar (Trim) a coluna de data.", "Dividir a coluna DateTime em duas colunas: uma de Data e outra de Tempo (Hora)."],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Na fonte de dados (At the data source)", "No serviço Power BI", "No Microsoft SharePoint", "No gateway de dados local"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Saber o número de linhas e colunas carregadas.", "Identificar claramente inconsistências de dados em seu conjunto de dados.", "Reduzir o tamanho do arquivo PBIX.", "Criar relações automaticamente."],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Table.RemoveColumns, List.Select e Text.EndsWith", "Table.SelectColumns, List.Filter e Text.StartsWith", "Table.DeleteColumns, List.Contains e Text.Contains", "Table.TransformColumns, List.Generate e Text.Replace"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Externa Completa (Full Outer)", "Interna (Inner)", "Externa Esquerda (Left Outer)", "Anti Direita (Right Anti)"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Limpar (Clean)", "Preencher Abaixo (Fill Down)", "Substituir Erros (Replace Errors)", "Substituir Valores (Replace Values)"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Remover valores vazios da primeira coluna", "Remover as 4 primeiras linhas", "Usar os cabeçalhos atuais como primeira linha", "Usar a primeira linha como cabeçalhos"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Criar visuais que agrupem os dados por hora", "Usar o Power Query para agrupar os dados do sensor por hora", "Adicionar um filtro de relatório para a coluna Hora", "Remover as linhas que contêm leituras"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Combinar Arquivos", "Mesclar Consultas", "Mesclar Colunas", "Acrescentar Consultas"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Adicionar uma fonte de dados de Pasta e usar o comando Combinar Arquivos", "Adicionar uma fonte de dados de Pasta e usar o comando Mesclar Consultas", "Adicionar uma fonte de dados do Excel e usar o comando Mesclar Consultas", "Adicionar fontes de dados texto/CSV individuais e usar o comando Acrescentar Consultas"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["No Editor de Consultas, atualizar todos os dados", "Mudar a consulta para modo de conexão dinâmica (Live Connection)", "Excluir a etapa Remover Duplicatas", "Adicionar uma etapa Desdinamizar Colunas"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Excluir a consulta, importar os dados para o SQL Server e depois reimportar", "No Editor de Consultas, adicionar uma coluna calculada que totaliza a coluna de valor de vendas", "Alterar o tipo de dados da coluna de valor de vendas para Numérico", "Atualizar o modelo de dados"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["No menu Formato, clicar em Aparar", "No menu Extrair, clicar em Últimos caracteres", "No menu Dividir Coluna, clicar em Por Delimitador", "No menu Extrair, clicar em Texto Após Delimitador"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Trim e Clean", "Substituir valores e Limpar", "Extrair e Formatar", "Dividir coluna e Aparar"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Selecionar a coluna Return type > Transformar > Substituir valores", "Selecionar a coluna Return type > Transformar > Preencher abaixo", "Selecionar a coluna Return type > Adicionar coluna > Coluna por exemplos", "Selecionar a coluna Return type > Início > Remover linhas"],
            correta: 0,
  ...
  "Modelar Dados": [
        {
            ...
            opcoes: ["Total Sales = SUM('Sales'[Total Sales Amount])", "Total Sales = ALL('Sales'[Total Sales Amount])", "Total Sales = MAX('Sales'[Total Sales Amount])", "Total Sales = CALCULATE([Total Sales])"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Modificar os filtros visuais.", "Converter a visualização temporariamente para um tipo diferente (ex: Tabela ou Barra) e ordenar lá.", "Remover o eixo de tendência do visual.", "Deletar o dataset inteiro."],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Na aba Modelagem (Modeling), alterar o Tipo de Dados (Data Type) ou formato para Porcentagem.", "Editar a consulta e alterar o tipo de dados lá.", "Criar uma coluna calculada que concatena '%' no final.", "Criar uma medida que adiciona '%' manualmente usando DAX FORMAT."],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Ordenar a coluna MonthName de forma descendente.", "Classificar a coluna MonthName por (Sort by column) MonthNumber.", "Ordenar a coluna MonthName de forma ascendente.", "Classificar a coluna MonthName por DateKey."],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Definir 'Summarize By' para Count na coluna CustomerID.", "Adicionar um sinônimo 'assinante' (subscriber) à tabela Customer.", "Criar uma nova tabela calculada filtrando assinantes.", "Adicionar uma descrição à medida 'Customer Count'."],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Mudar as medidas para usar funções iteradoras.", "Mudar o dataset importado para DirectQuery.", "Aumentar a frequência de atualização.", "Substituir os visuais padrão por visuais do AppSource."],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Agrupar as impressões por Ad_id, Site_name e Impression_date no Power Query e agregar usando CountRows.", "Criar uma medida calculada com COUNTROWS.", "Criar uma tabela calculada em DAX com Ad_id e Site_name.", "Manter todos os dados e usar DirectQuery."],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["O modo de armazenamento (Storage mode)", "A granularidade (nível de detalhe) na qual criá-las.", "O tipo de relacionamento", "A linguagem de consulta (DAX ou M)"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Sim, se for muitos-para-muitos.", "Sim, é totalmente suportado na versão mais recente.", "Não, ambas as colunas devem ter o mesmo tipo de dados.", "Sim, desde que uma seja texto e outra seja data."],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Direct query", "Query reduction (Redução de consulta)", "Query diagnostics", "Dual mode"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["A granularidade dos dados.", "O tempo que os dados levam para carregar.", "A singularidade (uniqueness) dos valores em uma coluna. Ex: Relação um-para-muitos.", "Um tipo de elemento visual."],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Q&A", "Column profiling (Criação de perfil de coluna)", "Performance analyzer (Analisador de desempenho)", "Query diagnostics"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Sales Amount = COUNT(Sales[SalesAmt])", "Sales Amount = Sales", "Sales Amount = Sales[SalesAmt]", "Sales Amount = SUM(Sales[SalesAmt])"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["EOMONTH", "FIRSTNONBLANK", "LASTNONBLANK", "NETWORKDAYS"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["CALCULATE(SUM(FactInventory[UnitsBalance]), LASTDATE('Date'[Date]))", "CALCULATE(SUM(FactInventory[UnitsBalance]), FIRSTDATE('Date'[Date]))", "CALCULATE(SUM(FactInventory[UnitsBalance]), MAX('Date'[Date]))", "SUM(FactInventory[UnitsBalance])"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Calculated column (Coluna calculada)", "Calculated table (Tabela calculada)", "Measure (Medida)", "What-If analysis"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["(SUM(Assets[Value]) - CALCULATE(SUM(Assets[Value]), SAMEPERIODLASTYEAR('Date'[Date]))) / CALCULATE(SUM(Assets[Value]), SAMEPERIODLASTYEAR('Date'[Date]))", "CALCULATE(SUM(Assets[Value]), SAMEPERIODLASTYEAR('Date'[Date])) / SUM(Assets[Value])", "CALCULATE(SUM(Assets[Value]), DATESYTD('Date'[Date])) / SUM(Assets[Value])", "SUM(Assets[Value]) / CALCULATE(SUM(Assets[Value]), SAMEPERIODLASTYEAR('Date'[Date]))"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["AVERAGE('Person'[Age])", "MEDIAN('Person'[Age])", "RANK.EQ('Person'[Age], 'Person'[Age])", "PERCENTILE.INC('Person'[Age], 0.5)"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["DATEADD e LASTNONBLANK", "DATESYTD e MAX", "SAMEPERIODLASTYEAR e MIN", "DATESBETWEEN e TODAY"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["LASTDATE", "TOTALYTD", "SAMEPERIODLASTYEAR", "PREVIOUSYEAR"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["RANKX(ALL(Sales), SUMX(RELATEDTABLE(Customer), [Sales_amount]))", "TOPN(ALL(Customer), SUMX(RELATEDTABLE(Sales), [Sales_amount]))", "RANKX(ALL(Customer), SUMX(RELATEDTABLE(Sales), [Sales_amount]))", "RANK.EQ(Sales[sales_amount], Customer[CustomerID])"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["FORMAT([Date], \"MMM\") & \" \" & FORMAT([Date], \"DD\") & \", \" & FORMAT([Date], \"YYYY\")", "FORMAT([Date], \"M\") & \" \" & FORMAT([Date], \"D\") & \", \" & [Date].[Year]", "[Date].[Month] & \" \" & FORMAT([Date], \"D\") & \", \" & [Date].[Year]", "FORMAT([Date], \"MMMM DD, YYYY\")"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["SUM(sales[sales_amount]) - CALCULATE(SUM(sales[sales_amount]), DATESYTD('Date'[Date]))", "CALCULATE(SUM(sales[sales_amount]), SAMEPERIODLASTYEAR('Date'[Date]))", "SUM(sales[sales_amount]) - CALCULATE(SUM(sales[sales_amount]), SAMEPERIODLASTYEAR('Date'[Date]))", "CALCULATEX(SUM(sales[sales_amount]), DATESYTD('Date'[Date]))"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["DATESYTD", "DATEADD", "DATESINPERIOD", "Todas as anteriores"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Eles são usados para alterar o contexto de filtro", "Eles são usados para acessar relacionamentos de tabela inativos", "Eles permitem arrastar e soltar campos em vez de escrever DAX do zero", "Eles são usados para alterar como os filtros se propagam"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Apenas TOPN", "Apenas FILTER", "Apenas DATEADD", "Todas as anteriores (TOPN, FILTER e DATEADD)"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["CALCULATE", "SUMX", "RELATED", "REPLACE"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Funções Lógicas", "Funções de Filtro", "Funções Estatísticas", "Funções de Iteração (Iterator Functions)"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Linhas (Rows)", "Colunas (Columns)", "Valores (Values)", "Filtros (Filters)"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Elas são avaliadas com base no contexto de linha", "Elas referenciam tabelas ou colunas inteiras", "Elas não são visíveis dentro das tabelas", "Elas recalculam em resposta a qualquer mudança nos filtros do relatório"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Nos dados de origem (fonte)", "No Power Query", "No modelo de dados", "Todos os métodos produzem os mesmos resultados"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Data Analysis Expressions", "Data & Analysis Exchange", "Data Aggregation Expressions", "Dynamic Analysis Expressions"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Table.AddColumn(..., each Date.StartOfWeek([Date], Day.Sunday), type date)", "Table.AddColumn(..., each Date.StartOfWeek([Date], Day.Monday), type date)", "Table.AddColumn(..., each Date.EndOfWeek([Date], Day.Sunday), type date)", "Table.AddColumn(..., each Date.EndOfWeek([Date], Day.Tuesday), type date)"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["TOPN, SUMMARIZE e DESC", "TOPN, CALCULATE e ASC", "FILTER, SUMMARIZE e DESC", "RANKX, ALL e DESC"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Dividir o modelo em múltiplos modelos", "Ocultar colunas não utilizadas no modelo", "Mesclar tabelas usando o Power Query", "Transpor as tabelas"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Mesclar as tabelas Customer e Address", "Transpor as tabelas Customer e Address", "Agrupar as tabelas Customer e Address pela coluna Address ID", "Acrescentar as tabelas Customer e Address"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["TOTALYTD e PREVIOUSMONTH", "CALCULATE e TOTALYTD", "CALCULATE e PREVIOUSMONTH", "DATEADD e SAMEPERIODLASTYEAR"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Funções de inteligência de tempo (Time intelligence)", "Funções de comparação (Comparer functions)", "Funções de valor (Value functions)", "Funções de filtro (Filter functions)"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Aditiva (Additive)", "Agregada (Aggregate)", "Semi-aditiva (Semi-additive)", "Não aditiva (Non-additive)"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Para criar medidas que se comportem de acordo com a seleção do usuário", "Para criar medidas que se comportem de acordo com sua intenção, independentemente do que o usuário seleciona", "Para melhorar o desempenho das consultas", "Para ocultar dados sensíveis dos usuários"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["SUMX", "CALCULATE", "ALL", "FILTER"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Medidas", "Colunas calculadas", "Tabelas calculadas", "Hierarquias"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Colunas calculadas", "Tabelas calculadas", "Medidas", "Parâmetros de campo"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Resumir a tabela DimDate ao nível de mês", "Resumir a tabela FactSales ao nível de mês", "Resumir a tabela FactSales ao nível de categoria de produto", "Resumir a tabela FactSales ao nível de trimestre"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Muitos-para-muitos", "Muitos-para-um", "Um-para-muitos", "Um-para-um"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Dimensão degenerada", "Dimensão junk", "Dimensão outrigger", "Dimensão de interpretação múltipla (role-playing dimension)"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Dimensão de Data (Date Dimension)", "Dimensão de Localização (Location Dimension)", "Fato de Localização (Location Fact)", "Fato de Medições de Temperatura (Temperature Measurements Fact)"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Um-para-um de Sales para Sales Detail", "Um-para-muitos de Sales para Sales Detail", "Muitos-para-muitos de Sales para Sales Detail", "Muitos-para-um de Sales para Sales Detail"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Referenciar a consulta Sale Date", "Duplicar a consulta Sale Date", "Renomear a consulta Sale Date para Ship Date", "Acrescentar a consulta Sale Date como uma nova consulta"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Criar uma nova tabela com colunas para data, ano, semana e dia", "Criar uma nova hierarquia na tabela Sales", "Formatar a visualização e definir o tipo do Eixo X como Categórico", "Configurar um filtro visual para a coluna Date usando filtro avançado"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Formato e depois Limpar", "Data e depois Mais Antigo", "Preencher e depois Abaixo", "Substituir Valores e depois Substituir Erros"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Modificar a medida para usar a função DAX CALCULATE", "Criar um relacionamento entre a tabela CustomerVisits e a tabela Date", "Modificar a medida para usar a função DAX SUM", "Criar uma hierarquia na tabela Date"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Criar um relacionamento um-para-um entre Product e Salesperson", "Para cada relacionamento, alterar a direção do filtro cruzado para Ambos (Both)", "Para cada relacionamento, alterar a cardinalidade para Um para um (1:1)", "Criar um relacionamento muitos-para-um entre Product e Salesperson"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Deve conter todos os dias de todos os anos representados no modelo", "Não pode conter datas duplicadas", "Deve ter pelo menos um campo definido como tipo Date ou DateTime", "Todos os itens acima"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Mesclar cria dados redundantes", "Mesclar usa mais memória", "Mesclar usa mais poder de processamento", "Mesclar mantém métricas e dimensões em tabelas separadas"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Cardinalidade: Muitos-para-muitos; Direção de filtro cruzado: Ambos", "Cardinalidade: Um-para-muitos (Customers para Invoice); Direção de filtro cruzado: Único", "Cardinalidade: Um-para-um; Direção de filtro cruzado: Ambos", "Cardinalidade: Um-para-muitos (Invoice para Customers); Direção de filtro cruzado: Único"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["RELATED", "RELATEDTABLE", "USERELATIONSHIP", "ACTIVATE"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Por padrão, o filtro aponta do lado 'um' para o lado 'muitos'", "Quando você filtra uma tabela, o contexto de filtro é passado para todas as tabelas 'downstream' relacionadas", "Os filtros não podem fluir 'upstream' (contra a direção da seta)", "Todas as alternativas acima"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Chave primária", "Chave estrangeira", "Coluna de índice", "Tabela de consulta (lookup)"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Chave primária (Primary key)", "Chave estrangeira (Foreign key)", "Chave nativa (Native key)", "Chave única (Unique key)"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Nome do produto", "Preço de varejo", "Quantidade vendida", "Marca do produto"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Usar esquema estrela com relacionamentos muitos-para-muitos", "Usar relacionamentos com filtros unidirecionais", "Ter tabelas que servem propósitos específicos (fatos e dimensões)", "Incluir apenas os dados necessários para análise"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Conectar as tabelas via relacionamentos baseados em seus campos comuns", "Conectar às tabelas em um único arquivo Power BI", "Mesclar as tabelas em uma única tabela mestre", "Dar nomes relacionados às tabelas"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Tabela de fatos", "Tabela de dimensão", "Tabela de datas", "Tabela de dados"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Dimensão de interpretação múltipla (Role-playing dimension)", "Dimensão floco de neve (Snowflake dimension)", "Dimensão degenerada (Degenerate dimension)", "Dimensão conformada (Conformed dimension)"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Relacionamento muitos-para-muitos", "Relacionamento um-para-muitos", "Relacionamento muitos-para-um", "Relacionamento um-para-um"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Tabelas de fatos armazenam observações ou eventos; tabelas de dimensão contêm informações sobre entidades específicas nos dados", "Tabelas de fatos contêm informações sobre entidades; tabelas de dimensão contêm dados observacionais", "Tabelas de dimensão definem papéis no Power BI; tabelas de fatos fornecem fatos associados", "Não há diferença entre elas"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Tabelas ativas e inativas", "Tabelas de dados qualitativos e quantitativos", "Tabelas de fatos e tabelas de dimensão", "Tabelas primárias e secundárias"],
            correta: 2,
...
,
  ...
  "Visualizar e Analisar": [
        ...
        },
        {
            ...
            opcoes: ["Create a new aggregation that summarizes by employee.", "Create a new group on the state column and set the Group type to List.", "Create a new group on the state column and set the Group type to Bin.", "Create a new aggregation that summarizes by state."],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Publish the app workspace.", "Share the dashboard in the app workspace.", "Edit the settings of the Power BI web part.", "Modify the members of the app workspace."],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Visual 1", "Visual 2", "Visual 3", "Visual 4", "Visual 5"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["A workspace is a feature in Power BI service that allows you to view reports only.", "A workspace is a feature that allows you to view and edit the data model, build visualizations, and transform the data.", "A workspace is a feature of Power BI Desktop that allows you to build reports only.", "A workspace is a centralized location or repository that allows you to collaborate with colleagues and teams to create collections of reports, dashboards, etc."],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["The visual was built by using a different version of R.", "The data comes from a Microsoft SQL Server source.", "The data is deduplicated.", "Too many records were sent to the visual."],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Add a Microsoft SQL Server Analysis Services (SSAS) data source that uses Connect live and create a report. Pin the report to a dashboard.", "Create an app workspace and publish the workspace to a dashboard.", "Add a Microsoft Azure SQL database data source that uses DirectQuery and create a report. Pin the report to a dashboard.", "Add a custom streaming data tile to a dashboard."],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Drill through filters", "Tooltips", "R visuals", "Page filters"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["No, dashboards can only be created from a single dataset or report.", "Yes, dashboards can be created from multiple datasets or reports."],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Color scale", "Rules", "Field value"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Adicionar um visual de relatório paginado (Paginated report visual).", "No painel Visualização, selecionar 'Obter mais visuais' (Get More Visuals).", "Importar um visual de um arquivo local.", "Adicionar um visual do Python à página de relatório."],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Matriz (Matrix)", "Gráfico de colunas (Column chart)", "Gráfico de dispersão (Scatter chart)", "Gráfico de medidor (Gauge chart)"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Filtrar os gráficos no slicer e então criar marcadores (bookmarks).", "Configurar filtros de nível de página e usar o agrupamento List.", "Criar filtros de nível de relatório e agrupar por Bin.", "Configurar filtros drillthrough para cada gráfico de barras."],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Matriz (Matrix)", "KPI nativo", "Cartão de várias linhas (Multi row card)", "Tabela (Table)"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Adicionar um Slicer usando a coluna de ano.", "Definir um filtro de nível visual na barra.", "Editar as interações (Edit Interactions) a partir do menu Formatar.", "Definir um filtro visual na rosca."],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["No campo Eixo (Axis), adicione Country no topo, seguido por ProvState e depois City.", "No campo Valor (Value), adicione Country no topo, seguido por ProvState, e depois City.", "No campo Legenda (Legend), adicione Country, e no campo Eixo, ProvState seguido por City.", "Mude o gráfico para um Treemap."],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Nível de página (Page level)", "Nível visual (Visual level)", "Nível de relatório (Report level)", "Drill through"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Árvore de Decomposição (Decomposition Tree)", "Gráfico de Linhas", "Principais Influenciadores (Key Influencers)", "Mapa de Árvore (Treemap)"],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Gráfico de Linhas", "Árvore de Decomposição (Decomposition Tree)", "Principais Influenciadores (Key Influencers)", "Mapa de Árvore (Treemap)"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Filtro Top N", "Segmentador de Dados de Data (Date Slicer)", "Filtro de Nível de Relatório", "Segmentador Categórico"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Filtro Dinâmico (Dynamic)", "Filtro Básico (Basic)", "Filtro Avançado (Advanced)", "Top N"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Consultas em SQL", "Expressões DAX", "Consultas em linguagem natural (Natural language queries)", "Código M (Power Query M)"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Gráfico de colunas clusterizado", "Gráfico de dispersão", "Gráfico de cascata", "Gráfico de linhas (Line chart)"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Mostrar padrões e anomalias em grandes conjuntos de dados bivariados.", "Comparar valores categóricos de texto único.", "Exibir totais percentuais com fatias.", "Mostrar fluxo de entrada e saída."],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Criar caixas de texto com links absolutos.", "Criar botões com a ação definida como Navegação de Página (Page navigation) ou Marcador (Bookmark).", "Criar um visual do Power Apps com um menu suspenso.", "Criar segmentações de página."],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Gráfico de área empilhada", "Gráfico de rosca (Donut chart)", "Gráfico de cascata (Waterfall)", "Gráfico de linhas (Line chart)"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Gráfico de colunas clusterizado", "Gráfico de dispersão (Scatter chart)", "Gráfico de barras 100% empilhadas", "Árvore de decomposição"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Filtro (Filter)", "Realce (Highlight)", "Nenhum (None)", "Drillthrough"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Adicionar salário aos campos de drillthrough.", "Adicionar salário aos tooltips (dicas de ferramenta).", "Adicionar um filtro visual de salário.", "Alterar o gráfico de linhas para um gráfico de dispersão."],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Não, marcadores não são dinâmicos.", "Não, é necessário um visual específico do AppSource.", "Sim, adicionando botões como navegação para alternar entre marcadores salvos.", "Sim, usando a funcionalidade de reprodução automática nativa no Desktop."],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Usando o analisador de desempenho (Performance Analyzer).", "Analisando seus metadados no Power Query.", "Usando o SQL Server Profiler conectado ao modelo importado.", "Verificando os logs do Gateway de dados local."],
            correta: 0,
        ...
        },
        {
            ...
            opcoes: ["Filtro de nível de relatório (Report level)", "Filtro de tipo de página (Page type)", "Filtro de nível de página (Page level)", "Drillthrough"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Não, visuais personalizados estão sempre disponíveis na aba Visualizations.", "Não, importando uma vez, eles ficam permanentemente no Power BI Desktop.", "Sim, visuais personalizados devem ser importados do AppSource cada vez que você começa um novo relatório.", "Sim, mas apenas para relatórios no Power BI Service."],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Dar aos usuários a capacidade de exportar dados do visual.", "Dar aos usuários informações sobre o autor do relatório.", "Fornecer detalhes adicionais específicos ao contexto dos dados sobre os quais se passa o mouse.", "Permitir o drill-through para outras páginas."],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["A categoria de dados (Data Category) de Region", "A sumarização padrão (Default Summarization) em Region", "A sumarização padrão (Default Summarization) em Sales", "O tipo de dados de Sales"],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Adicionar sinônimos a tabelas e colunas", "Adicionar relacionamentos ausentes entre tabelas", "Corrigir tipos de dados incorretos", "Adicionar rótulos de eixo a todos os gráficos"],
            correta: 3,
...
,
  ...
  "Implementar e Manter": [
        ...
        },
        {
            ...
            opcoes: ["USER", "USERPRINCIPALNAME", "ROLE", "USERELATIONSHIP"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Faster refresh times", "More reliable", "Reduced resource usage", "All of the above"],
            correta: 3,
        ...
        },
        {
            ...
            opcoes: ["Somente Report1.pbix", "Report1.pbix e Report3.pbix", "Todos suportam", "Somente Report2.pbix"],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["A partir do painel de Vendas, defini-lo como Favorito.", "Das configurações de idioma do workspace.", "Nas propriedades dos datasets, modificar as configurações de Q&A.", "A partir das propriedades do dashboard, modificar as configurações."],
            correta: 2,
        ...
        },
        {
            ...
            opcoes: ["Criar um alerta de dados (Data Alert).", "Criar uma assinatura (Subscription) para o e-mail dele.", "Compartilhar o dashboard marcando a opção de notificação diária.", "Mencioná-lo em um comentário diário automático."],
            correta: 1,
        ...
        },
        {
            ...
            opcoes: ["Visual Studio 2022", "Node.js", "Azure PowerShell", "jQuery"],
            correta: 1,
